...
![Select projects to activate SharePoint storage in in OpenProject administration](openproject_system_guide_sharepoint_add_multiple_projects.png)
...
> [!IMPORTANT]
> Deleting a file storage as an instance administrator will also delete all settings and links between work packages and SharePoint files/folders. This means that should you want to reconnect your SharePoint instance with OpenProject, you will need complete the entire setup process once again.
